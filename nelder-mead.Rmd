...
Chollet](https://github.com/fchollet/nelder-mead) found at (also in the
[Miscellaneous R code
repo](https://github.com/m-clark/Miscellaneous-R-Code/blob/master/ModelFitting/nelder_mead.py).
This is mostly just an academic exercise on my part.  I'm not sure how much one
would use the basic NM for many situations. In my experience BFGS and other
approaches would be faster, more accurate, and less sensitive to starting values
for the types of problems I've played around with. Others who actually spend
their time researching such things seem to agree.
