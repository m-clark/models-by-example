...
We'll start with the a basic maximum likelihood function for a standard probit.  See the [logistic regression][Standard Logistic] and [previous chapter on probit models][Probit & Bivariate Probit] for comparison.
