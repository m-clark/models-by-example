...
Marginal structural model for the causal effect of `a` on `y` corrected for confounding by `l`, using inverse probability weighting with robust standard error from the <span class="pack" style = "">survey</span> package.
...
Create the matrices for estimation, estimate the model, and extract results.
...
Base R source code found at https://github.com/m-clark/Miscellaneous-R-Code/blob/master/ModelFitting/ipw.R
