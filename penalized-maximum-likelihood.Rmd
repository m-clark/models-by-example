...
A standard regression model via penalized likelihood.  See the [linear regression example][Standard Linear Regression]
...
approach to the lasso in the lasso.R file.
...
Source code found at https://github.com/m-clark/Miscellaneous-R-Code/blob/master/ModelFitting/penalized_ML.R