...
y = -.5 + .2*X[:, 0] + .1*X[:, 1] + np.random.normal(scale = .5, size = N).reshape(N, 1)  # increasing N will get estimated values closer to these
...
# you may get wranings, they can be ignored
result = minimize(
  lm_ML,
  x0 = [1, 0, 0, 0],
