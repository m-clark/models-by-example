...
gradient descent][Gradient Descent] In the following, we have basic data 
...
Source code found at https://github.com/m-clark/Miscellaneous-R-Code/blob/master/ModelFitting/stochastic_gradient_descent.R
